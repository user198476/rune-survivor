...
const HORDE_BOMB_SPAWN_INTERVAL = 20;
const HORDE_BOMB_MIN_ENEMIES_TO_SPAWN = 18;

// grey enemy
const HORDE_BOMB_RADIUS = 24;
const HORDE_BOMB_SPEED = 360;
const HORDE_BOMB_HP = 180;
const HORDE_BOMB_EXPLOSION_RADIUS = 155;
const HORDE_BOMB_PLAYER_DAMAGE_RATIO = 0.20;
const HORDE_BOMB_KNOCKBACK_FORCE = 420;
const HORDE_BOMB_MAX_LIFE = 8;

const HORDE_BOMB_TARGET_SEARCH_RADIUS = 190;
